...
<main style="height: auto; display: flex; flex-direction: row;">
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px; height: auto;">
    <div class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <span class="fs-4">
        Администратирование

        <p> <?php echo '<div class="link-active">' . $user->login . ' - Доступ: ' . $user->access . ' lvl</div>'; ?> </p>
      </span>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="#home" class='nav-link text-white <?php echo $home_active; ?>'>
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
          Главная
        </a>
      </li>
      <li>
        <a href="#settings" class='nav-link text-white <?php echo $settings_active ?>'>
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
          настройки vEngine
        </a>
      </li>
      <li>
        <a href="#news" class='nav-link text-white <?php echo $news_active ?>'>
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"></use></svg>
          Управление новостями
        </a>
      </li>
      <li>
        <a href="#store" class='nav-link text-white <?php echo $store_active ?>'>
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"></use></svg>
          Магазин
        </a>
      </li>
      <li>
        <a href="#users" class='nav-link text-white <?php echo $users_active ?>'>
    ...
    <hr>
<div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle show" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
<!--         <img src="" alt="avatar" width="32" height="32" class="rounded-circle me-2"> -->
        <strong>Меню</strong>
      </a>
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow show" aria-labelledby="dropdownUser1" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(0px, -34px);" data-popper-placement="top-start">
        ...
        <li><a class="dropdown-item" href="http://support.<?= $_SERVER['HTTP_HOST'] ?>/admin">Служба поддержки (админ)</a></li>        
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="logout">Выход с аккаунта</a></li>
      </ul>
    </div>
  </div>
