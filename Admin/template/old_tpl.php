  ...
  <body>
   <div class="out">
               ...
               <nav class="nav">
                   <ul class="nav__list">
                       <li class="nav__list-item">
                           <a href="admin" class="nav__list-link <?=!$_GET ? 'active' : ''?>" title="Home">
                       ...
                       <br>
                       <li class="nav__list-item">
                           <a href="?users=1" class="nav__list-link <?=$_GET['users'] ? 'active' : ''?>" title="Clients">
                       ...
                       <br>
                       <li class="nav__list-item">
                           <a href="?test=1" class="nav__list-link <?=$_GET['test'] ? 'active' : ''?>" title="Favorite">
                       ...
                       <br>
                       <li class="nav__list-item">
                           <a href="?settigns=1" class="nav__list-link <?=$_GET['settigns'] ? 'active' : ''?>" title="Settings">
       ...
       <main class="main js-main">
           <h1>Client</h1>
           <p>  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: auto; margin-left: 2%; position: relative; height: auto;">
             ...
             <form action="" method="POST" name="logs" class="logs">
               ...
               <input type="submit" name="button_lg" value='Логи'>
             </form>
             <br>
             <hr>
             ...
             <form action="" method="POST" name="_news" class="news" style="display: flex; flex-direction: column;">
               ...
               <textarea type="text" name="text" style="min-width: 150px; min-height: 100px;"></textarea>
